...
plt.plot(ks[kmin_m:], list(np.zeros(n-kmin_m)), linestyle='-', color='g')
plt.plot(ks[kmin_m:], list(np.zeros(n-kmin_m)), linestyle='-', color='r')
...
p_null = binom.pmf(ks, n, p0)
kmin_b = kmin_bravo(1, n, 0, 0, p1, p0, alpha)
plt.plot(ks[:kmin_m], p_alt[:kmin_m], linestyle='-', color='g')
plt.plot(ks[:kmin_m], p_null[:kmin_m], linestyle='-', color='r')
plt.plot(ks[kmin_m:], list(np.zeros(n-kmin_m+1)), linestyle='-', color='g')
plt.plot(ks[kmin_m:], list(np.zeros(n-kmin_m+1)), linestyle='-', color='r')
