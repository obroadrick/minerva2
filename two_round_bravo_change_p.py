...
bravokmins, minervakmins = np.array(bravokmins) / n1, np.array(minervakmins) / n1
plt.plot(ps, bravokmins, label='r=100, bravo kmins')
plt.plot(ps, minervakmins, label='r=100, minerva kmins')

# and now what if we had done this for round size 120 not 100?
n1 = 150
ps = []
bravokmins = []
minervakmins = []
...
# plot
bravokmins, minervakmins = np.array(bravokmins) / n1, np.array(minervakmins) / n1
plt.plot(ps, bravokmins, label='r=120, bravo kmins')
plt.plot(ps, minervakmins, label='r=120, minerva kmins')
plt.legend(loc='upper right')
plt.ylabel('kmin as proportion of round size')
